...
func (ds *DriverStorage) AddDriver(driver *data.Driver) {
	...
	ds.companyDrivers[driver.CompanyName] = append(ds.companyDrivers[driver.CompanyName], driver)
	ds.Unlock()
}
